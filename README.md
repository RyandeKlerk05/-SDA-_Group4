...
1. Project Description:
   This study discusses a possible correlation between mental health issues and the usage of social media.
   The study attempts to find a correlation between different age groups and their mental health state with the
   platforms they use. The duration of social media usage for each age group will also be studied. 

3. Github structure:
    - **Data**: The raw data (like .csv files) we use for our experiments.
